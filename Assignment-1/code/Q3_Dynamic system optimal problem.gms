$ title Dynamic system optimal problem
...
equations
so_obj
comm_flow_on_node_origin(a,i,t)
comm_flow_on_node_intermediate(a,i,t)
comm_flow_on_node_destination(a,i,t)
flow_def(i,j,t,s)
...
flow_def(i,j,t,s)$(cap(i,j,t,s)>0.1)..f(i,j,t,s) =e= sum(a,x(a,i,j,t,s));
cap_constraint(i,j,t,s)$(cap(i,j,t,s)>0.1).. cap(i,j,t,s)-f(i,j,t,s) =g= 0;

Model so /all/;
solve so using MIP minimizing z;
display z.l;
display x.l;
